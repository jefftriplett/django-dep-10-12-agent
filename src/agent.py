...
def mcp(
    ...
    server = FastMCP("django-dep-10-12-agent")
    cached = {}
    ...
    @server.tool
    async def governance_question(question: str) -> Output:
        """Answer a question about Django governance based on DEP 10 and DEP 12."""
